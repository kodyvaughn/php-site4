...
if (isset($_SESSION['water'])) { /* If there is already a value set */
  /*Do Nothing*/
}
else { /* If there is no value set, ie the user is loading the page for the first time */
  $_SESSION['water'] = 0; /* Set to 0 */
}
...
{
   $_SESSION['water'] = $_SESSION['water'] + 1;
}
